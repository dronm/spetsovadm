<template>
	<button
		class="flex justify-center items-center gap-1.5 border border-[color:var(--gray-300)] [background:var(--gray-50)] px-4 py-2.5 rounded-lg border-solid cursor-pointer"
		:title="t('GridCmdAddRow.title')"
